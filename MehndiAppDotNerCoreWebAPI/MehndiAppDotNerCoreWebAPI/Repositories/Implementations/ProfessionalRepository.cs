...
namespace MehndiAppDotNerCoreWebAPI.Repositories.Implementations
{
    public class ProfessionalRepository : IProfessionalRepository
    {
        ...
        public async Task<int> AddProfessional(Professional professional)
        {
            ...
            string procedureName = "MH_ProfessionalSignup";
            ...
            try
            {
                ...
                return await _sqlHelper.ExecuteNonQuery(procedureName, parameters);
            }
        ...
        {
            // Convert the customer object to JSON
            var loginJson = JsonConvert.SerializeObject(professionalLoginRequest);

            // Define the stored procedure name
            string procedureName = "MH_ProfessionalLogin";
